...
to-report list-rules  ;; return a list of state-transition 4-tuples corresponding to the switches
  report (list lput ooo [true true true]
               lput ooi [true false true ]
               lput oio [true true  true]
               lput oii [false true  false ]
               lput ioo [true  false false]
               lput ioi [true  true true ]
               lput iio [false  false  false]
               lput iii [true  false  true]
  )
end
